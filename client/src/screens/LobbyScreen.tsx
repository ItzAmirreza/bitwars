...
function PixelBar({ colors, height = 4 }: { colors: string[]; height?: number }) {
  return (
    <div style={{ display: 'flex', gap: '2px' }}>
      {colors.map((c, i) => (
        <div key={i} style={{ width: '10px', height: `${height}px`, background: c, opacity: 0.7 }} />
      ))}
    </div>
  );
}
...
export function LobbyScreen() {
  ...
  const handleEnterGame = () => { menuAudio.playUIDeploy(); setScreen('game'); };
  ...
  return (
    <div style={{
      ...
      position: 'relative', overflow: 'hidden', background: '#0a0c14',
    }}>
      <PixelArtBg />
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <PixelBar colors={['#ff6b35', '#ffd600', '#76ff03', '#00e5ff', '#7c4dff']} />
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Play section */}
          <div className="anim-scale-in" style={{ animationDelay: '0.15s', width: '100%' }}>
            <div style={{
          ...
          {/* Players list */}
          {onlineCount > 0 && (
            <div className="anim-fade-up" style={{ animationDelay: '0.3s', width: '100%' }}>
              <div style={{
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                fontFamily: 'var(--font-pixel)',
                fontSize: '8px',
                ...
                {players.map((p: any, i: number) => (
                  <div
                    ...
                    style={{
                      ...
                      fontFamily: 'var(--font-pixel)',
                      fontSize: '8px',
                      borderBottom: i < players.length - 1 ? '2px solid #1a1e2a' : 'none',
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      {/* Pixel avatar dot */}
                      <div style={{ width: '6px', height: '6px', background: '#ff6b35' }} />
                      <span style={{
                        color: p.username === username ? '#ffd600' : '#e8e8f0',
                      }}>
                        {p.username || 'Unknown'}
                      </span>
                      {p.username === username && (
                        <span style={{
                          fontSize: '6px', color: '#ffd600',
