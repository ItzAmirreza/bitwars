...
import { WEAPON_DATA, VEHICLE_WEAPON_DATA } from './weaponData';
import { WeaponSilhouette, MiniWeaponIcon } from './WeaponSVGs';

export interface BottomHudProps {
  state: EngineState;
}

export function BottomHud({ state }: BottomHudProps) {
      ...
      >
        <div className="flex items-end justify-between">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '3px' }}>
            ...
            {state.mountedVehicleName && <VehicleHud state={state} />}
...
// ── Vehicle HUD sub-component ──
function VehicleHud({ state }: { state: EngineState }) {
