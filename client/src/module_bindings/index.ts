...
import BlockSettleEventRow from "./block_settle_event_table";
...
const tablesSchema = __schema({
  ...
  block_settle_event: __table({
    name: 'block_settle_event',
    indexes: [
      { accessor: 'id', name: 'block_settle_event_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'block_settle_event_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, BlockSettleEventRow),
