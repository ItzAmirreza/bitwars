...
const tablesSchema = __schema({
  ...
  match_result: __table({
    ...
    indexes: [
      ...
      { name: 'idx_match_result_round', algorithm: 'btree', columns: [
        'roundNumber',
      ] },
    ],
    constraints: [
  ...
  player_buff: __table({
    ...
    indexes: [
      ...
      { name: 'idx_buff_identity', algorithm: 'btree', columns: [
        'identity',
      ] },
    ],
    constraints: [
  ...
  player_profile: __table({
    name: 'player_profile',
    indexes: [
      { name: 'idx_player_profile_name', algorithm: 'btree', columns: [
        'displayName',
      ] },
      { name: 'profile_id', algorithm: 'btree', columns: [
        'profileId',
  ...
  vehicle_occupant: __table({
    ...
    indexes: [
      ...
      { name: 'idx_vehicle_occupant_by_vehicle', algorithm: 'btree', columns: [
        'vehicleId',
      ] },
      { name: 'idx_vehicle_occupant_by_vehicle_seat', algorithm: 'btree', columns: [
        'vehicleId',
        'seatIndex',
      ] },
    ],
